...
namespace VivoxUnity
{
    ...
    /// <summary>
    /// Defines the policy of where microphone audio and injected audio get broadcast.
    /// </summary>
    public enum TransmissionMode
    {
        ...
        Single,
        /// <summary>
        /// Adopts a policy of transmission into all channels at once.
        /// </summary>
        All
    }
    ...
    /// <summary>
    /// Used for configuring a set of supported audio codecs.
    /// </summary>
    [DefaultValue(Opus40)]
    ...
    /// <summary>
    /// Unified selection of output stream and mechanism for TTS injection.
    /// </summary>
    public enum TTSDestination
    {
        /// <summary>
        /// Immediately send to participants in connected sessions (according to the transmission policy). Mixes new message with any other ongoing messages.
        /// </summary>
        RemoteTransmission = vx_tts_destination.tts_dest_remote_transmission,
        /// <summary>
        /// Immediately play back locally on render device (e.g. speakers). Mixes new message with any other ongoing messages.
        /// </summary>
        LocalPlayback = vx_tts_destination.tts_dest_local_playback,
        /// <summary>
        /// Immediately play back locally on render device, and send to participants in connected sessions (according to the transmission policy). Mixes new message with any other ongoing messages.
        /// </summary>
        ...
        /// <summary>
        /// Play back locally on render device (e.g. speakers), or enqueue if there is already an ongoing message playing in this destination.
        /// </summary>
        QueuedLocalPlayback = vx_tts_destination.tts_dest_queued_local_playback,
        /// <summary>
        /// Play back locally on render device, and send to participants in connected sessions. Enqueue if there is already an ongoing message playing in this destination.
        /// </summary>
        QueuedRemoteTransmissionWithLocalPlayback = vx_tts_destination.tts_dest_queued_remote_transmission_with_local_playback,
        /// <summary>
        /// Immediately play back locally on render device (e.g. speakers). Replaces the currently playing message in this destination.
        /// </summary>
        ScreenReader = vx_tts_destination.tts_dest_screen_reader
    }

    /// <summary>
    /// The state of the TTS message.
    /// </summary>
    public enum TTSMessageState
    {
        /// <summary>
        /// The message is not yet in the Text-To-Speech subsystem.
        /// </summary>
        NotEnqueued,
        /// <summary>
