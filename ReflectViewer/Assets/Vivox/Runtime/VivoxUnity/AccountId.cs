...
namespace VivoxUnity
{
    ...
    public sealed class AccountId
    {
        ...
        /// IETF language tag strings are not validated, but are expected to conform to BCP-47 (<a href="https://tools.ietf.org/html/bcp47">BCP-47</a>).
        ...
        /// </remarks>
        public AccountId(string issuer, string name, string domain, string displayname = null, string[] spokenLanguages = null)
        {
        ...
        /// <summary>
        /// Optional array of languages used as hints for audio transcription. Default is empty array, implies "en"
        /// Up to 3 spoken languages used in order of preference to inform transcription of all users in transcribed channels.
        /// IETF language tag strings are not validated, but are expected to conform to BCP-47 (<a href="https://tools.ietf.org/html/bcp47">BCP-47</a>).
        /// </summary>
        ...
        /// <summary>
        /// The name you assigned to the player for display purposes. If one is not set then Name will be returned.
        /// </summary>
