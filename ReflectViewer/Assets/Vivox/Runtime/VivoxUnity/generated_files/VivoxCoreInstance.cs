...
public class VivoxCoreInstance {
  ...
  public static int vx_alloc_sdk_handle(string address, ushort port, out uint handle) {
    int ret = VivoxCoreInstancePINVOKE.vx_alloc_sdk_handle(address, port, out handle);
    return ret;
  }
  ...
  public static int vxa_apcd_create(vxa_apcd_t capture_device, out int apcd_id) {
    int ret = VivoxCoreInstancePINVOKE.vxa_apcd_create(vxa_apcd_t.getCPtr(capture_device), out apcd_id);
    return ret;
  }
  ...
  public static int vxa_aprd_create(vxa_aprd_t render_device, out int aprd_id) {
    int ret = VivoxCoreInstancePINVOKE.vxa_aprd_create(vxa_aprd_t.getCPtr(render_device), out aprd_id);
    return ret;
  }
