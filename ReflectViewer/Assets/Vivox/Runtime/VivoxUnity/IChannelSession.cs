...
namespace VivoxUnity
{
    ...
    public interface IChannelSession : IKeyedItemNotifyPropertyChanged<ChannelId>
    {
        ...
        /// </summary>
        /// <remarks>Use the IReadOnlyQueue events to get notifications of incoming transcribed messages.</remarks>
        ...
        /// <param name="switchTransmission">Whether to transmit in this channel. Transmitting in one channel will stop transmitting in other channels.</param>
        ...
        /// <summary>
        /// Issues a request to set Transcription for this channel session.
        /// </summary>
        /// <param name="value">True to enable transcription, false to disable transcription.</param>
        /// <param name="accessToken">The access token granting the user access to set transciption on the channel. For testing purposes only use <see cref="GetTranscriptionToken"/></param>
        /// <param name="callback">a delegate to call when this operation completes</param>
        IAsyncResult BeginSetChannelTranscription(bool value, string accessToken, AsyncCallback callback);

        /// <summary>
        /// To be called by the consumer of this class when BeginSetChannelTranscription() completes.
        /// </summary>
