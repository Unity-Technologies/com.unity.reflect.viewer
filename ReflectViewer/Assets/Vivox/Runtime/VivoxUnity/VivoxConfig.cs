...
namespace VivoxUnity
{
    ...
    public class VivoxConfig
    {
        ...
        /// <summary>
        /// (iOS only) If set to false Vivox will set the proper iOS PlayAndRecord category.
        ...
        /// Only set this to true if you prefer to controle iOS PlayAndRecord category.  
        /// Improper PlayAndRecord category can result in loss of voice communication
        /// </summary>
