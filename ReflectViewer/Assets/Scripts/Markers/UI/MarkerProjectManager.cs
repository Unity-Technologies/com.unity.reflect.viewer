...
namespace Unity.Reflect.Viewer
{
    ...
    public class MarkerProjectManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            m_ActiveProjectSelector = UISelectorFactory.createSelector<Project>(ProjectManagementContext<Project>.current, nameof(IProjectDataProvider<Project>.activeProject));
