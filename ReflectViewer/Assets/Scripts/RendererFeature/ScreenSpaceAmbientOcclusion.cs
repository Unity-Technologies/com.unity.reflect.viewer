...
namespace Unity.Reflect.Viewer
{
    ...
    public static class RenderingExtensions
    {
        public static bool IsCameraProjectionMatrixFlipped(this CameraData data)
        {
            ...
            //if (renderer != null)
            //{
            //    bool renderingToTexture = /*renderer.cameraColorTarget != BuiltinRenderTextureType.CameraTarget ||*/ data.targetTexture != null;
    ...
    internal class ScreenSpaceAmbientOcclusion : ScriptableRendererFeature
    {
        ...
        // Constants
        private const string k_ShaderName = "Reflect/Universal Render Pipeline/ScreenSpaceAmbientOcclusion";
        ...
        {
            if (m_Material != null && m_SSAOPass.material != null)
            {
                return true;
            }
        ...
        private class ScreenSpaceAmbientOcclusionPass : ScriptableRenderPass
        {
            ...
            public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
            {
                ...
                // Update keywords
                CoreUtils.SetKeyword(material, k_OrthographicCameraKeyword, false); //renderingData.cameraData.camera.orthographic);
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                cmd.name = "Screen Space Ambient Occlusion";
                using (new ProfilingScope(cmd, m_ProfilingSampler))
                {
                    CoreUtils.SetKeyword(cmd, CustomShaderKeywordStrings.ScreenSpaceOcclusion, true);
                    ...
                    Render(cmd, source, ShaderPasses.MultiplyFinal);
                }
            ...
            public override void FrameCleanup(CommandBuffer cmd)
            {
                ...
                CoreUtils.SetKeyword(cmd, CustomShaderKeywordStrings.ScreenSpaceOcclusion, false);
