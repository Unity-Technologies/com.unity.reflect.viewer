...
#pragma warning restore CS0649
        ...
        Vector2 GetInput()
        {
            Vector2 input = m_InputActionAsset["Walk Navigation Action"].ReadValue<Vector2>();
            movementSettings.UpdateDesiredTargetSpeed(input, m_RunningAction.controls[0].IsPressed());
            return input;
        }
