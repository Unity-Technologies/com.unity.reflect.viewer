...
#define SAMPLE_SSAO_TEXTURE(uv)   SAMPLE_TEXTURE2D_X(_ScreenSpaceOcclusionTexture, sampler_ScreenSpaceOcclusionTexture, UnityStereoTransformScreenSpaceTex(uv));
...
float4 FinalMultiply(Varyings input) : SV_Target
{
    UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(input);
