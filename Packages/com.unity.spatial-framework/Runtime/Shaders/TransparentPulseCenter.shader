Shader "SpatialFramework/TransparentPulseCenter"
{
	Properties
	{
        ...
        _WaveSize ("Shine Frequency", Range (0.1, 50)) = .5
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert (appdata v)
			{
				...
				o.realWorldCameraDistance = ( mul(unity_ObjectToWorld, v.vertex).xyz - _Center.xyz )/ _WorldScale;
