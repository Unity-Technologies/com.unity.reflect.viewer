...
namespace Unity.Properties.CodeGen
{
    ...
    class Context
    {
        ...
        static readonly MethodInfo s_PropertyBagRegisterIListGenericMethodInfo;
        static readonly MethodInfo s_PropertyBagRegisterISetGenericMethodInfo;
        static readonly MethodInfo s_PropertyBagRegisterIDictionaryGenericMethodInfo;
        static readonly MethodInfo s_PropertyBagRegisterArrayGenericMethodInfo;
        static readonly MethodInfo s_PropertyBagRegisterListGenericMethodInfo;
        static readonly MethodInfo s_PropertyBagRegisterHashSetGenericMethodInfo;
        ...
        static Context()
        {
            ...
            s_PropertyBagRegisterIListGenericMethodInfo = typeof(PropertyBag).GetMethods().First(x => x.GetParameters().Length == 0 && x.Name == nameof(PropertyBag.RegisterIList));
            s_PropertyBagRegisterISetGenericMethodInfo = typeof(PropertyBag).GetMethods().First(x => x.GetParameters().Length == 0 && x.Name == nameof(PropertyBag.RegisterISet));
            s_PropertyBagRegisterIDictionaryGenericMethodInfo = typeof(PropertyBag).GetMethods().First(x => x.GetParameters().Length == 0 && x.Name == nameof(PropertyBag.RegisterIDictionary));
            s_PropertyBagRegisterArrayGenericMethodInfo = typeof(PropertyBag).GetMethods().First(x => x.GetParameters().Length == 0 && x.Name == nameof(PropertyBag.RegisterArray));
            ...
            s_PropertyBagRegisterHashSetGenericMethodInfo = typeof(PropertyBag).GetMethods().First(x => x.GetParameters().Length == 0 && x.Name == nameof(PropertyBag.RegisterHashSet));
        ...
        public readonly Lazy<MethodReference> PropertyBagRegisterIListGenericMethodReference;
        public readonly Lazy<MethodReference> PropertyBagRegisterISetGenericMethodReference;
        public readonly Lazy<MethodReference> PropertyBagRegisterIDictionaryGenericMethodReference;
        public readonly Lazy<MethodReference> PropertyBagRegisterArrayGenericMethodReference;
        public readonly Lazy<MethodReference> PropertyBagRegisterListGenericMethodReference;
        public readonly Lazy<MethodReference> PropertyBagRegisterHashSetGenericMethodReference;
        ...
        public Context(ModuleDefinition module, IEnumerable<string> defines)
        {
            ...
            PropertyBagRegisterIListGenericMethodReference = new Lazy<MethodReference>(() => Module.ImportReference(s_PropertyBagRegisterIListGenericMethodInfo));
            PropertyBagRegisterISetGenericMethodReference = new Lazy<MethodReference>(() => Module.ImportReference(s_PropertyBagRegisterISetGenericMethodInfo));
            PropertyBagRegisterIDictionaryGenericMethodReference = new Lazy<MethodReference>(() => Module.ImportReference(s_PropertyBagRegisterIDictionaryGenericMethodInfo)); 
            PropertyBagRegisterArrayGenericMethodReference = new Lazy<MethodReference>(() => Module.ImportReference(s_PropertyBagRegisterArrayGenericMethodInfo));
            ...
            PropertyBagRegisterHashSetGenericMethodReference = new Lazy<MethodReference>(() => Module.ImportReference(s_PropertyBagRegisterHashSetGenericMethodInfo));
