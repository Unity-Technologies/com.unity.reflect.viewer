...
namespace Unity.Properties
{
        ...
        IDictionaryPropertyVisitor
    {
        ...
        void IPropertyVisitor.Visit<TContainer, TValue>(Property<TContainer, TValue> property, ref TContainer container)
        {
            ...
            if (((IPropertyAcceptWithAdapters<TContainer, TValue>)property).IsExcluded(this, new ReadOnlyAdapterCollection(m_Adapters).GetEnumerator(), ref container, ref value))
                return;
            ...
            ((IPropertyAcceptWithAdapters<TContainer, TValue>)property).ContinueVisitation(this, new ReadOnlyAdapterCollection(m_Adapters).GetEnumerator(), ref container, ref value);
