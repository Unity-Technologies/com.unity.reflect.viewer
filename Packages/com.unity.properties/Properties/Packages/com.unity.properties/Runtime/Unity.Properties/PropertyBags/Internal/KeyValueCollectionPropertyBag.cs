...
namespace Unity.Properties.Internal
{
    ...
    class KeyValueCollectionPropertyBag<TDictionary, TKey, TValue> : PropertyBag<TDictionary>, IDictionaryPropertyBag<TDictionary, TKey, TValue>
        where TDictionary : IDictionary<TKey, TValue>
    {
        ...
        /// <inheritdoc/>
        bool IPropertiesKeyed<TDictionary, object>.TryGetProperty(ref TDictionary container, object key, out IProperty<TDictionary> property)
        {
