        ...
        class AOT
        {
            ...
            struct Container
            {
                ...
                internal class PropertyBag : ContainerPropertyBag<Container>
                {
                    static PropertyBag()
                    {
                        Properties.PropertyBag.RegisterList<Container, int>();
                        Properties.PropertyBag.RegisterList<Container, Nested>();
                        Properties.PropertyBag.RegisterList<Container, IData>();
                        Properties.PropertyBag.RegisterList<Container, List<float>>();
                        Properties.PropertyBag.RegisterList<List<List<float>>, float>();
                    }
            ...
            public void PropertyVisitor_VisitingAUserDefinedContainerUsingAUserDefinedVisitor_DoesNotThrow()
            {
                ...
                PropertyContainer.Accept(new UserDefinedVisitor(), container);
            }
